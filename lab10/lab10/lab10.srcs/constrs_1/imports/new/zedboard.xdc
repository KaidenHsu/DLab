...
set_property -dict {PACKAGE_PIN F22 IOSTANDARD LVCMOS33} [get_ports { reset_n }]; #"SW0"
...
set_property -dict { PACKAGE_PIN AB22 IOSTANDARD LVCMOS33 } [get_ports { VGA_GREEN[0] }];  # "VGA-G1"
set_property -dict { PACKAGE_PIN AA22 IOSTANDARD LVCMOS33 } [get_ports { VGA_GREEN[1] }];  # "VGA-G2"
set_property -dict { PACKAGE_PIN AB21 IOSTANDARD LVCMOS33 } [get_ports { VGA_GREEN[2] }];  # "VGA-G3"
set_property -dict { PACKAGE_PIN AA21 IOSTANDARD LVCMOS33 } [get_ports { VGA_GREEN[3] }];  # "VGA-G4"

set_property -dict { PACKAGE_PIN AA19 IOSTANDARD LVCMOS33 } [get_ports { VGA_HSYNC }];  # "VGA-HS"

set_property -dict { PACKAGE_PIN V20 IOSTANDARD LVCMOS33 } [get_ports { VGA_RED[0] }];  # "VGA-R1"
set_property -dict { PACKAGE_PIN U20 IOSTANDARD LVCMOS33 } [get_ports { VGA_RED[1] }];  # "VGA-R2"
set_property -dict { PACKAGE_PIN V19 IOSTANDARD LVCMOS33 } [get_ports { VGA_RED[2] }];  # "VGA-R3"
set_property -dict { PACKAGE_PIN V18 IOSTANDARD LVCMOS33 } [get_ports { VGA_RED[3] }];  # "VGA-R4"

set_property -dict { PACKAGE_PIN Y19 IOSTANDARD LVCMOS33 } [get_ports { VGA_VSYNC }];  # "VGA-VS"
...
set_property -dict { PACKAGE_PIN P16  IOSTANDARD LVCMOS33 } [get_ports { usr_btn[0] }];
set_property -dict { PACKAGE_PIN R16  IOSTANDARD LVCMOS33 } [get_ports { usr_btn[3] }];
set_property -dict { PACKAGE_PIN N15  IOSTANDARD LVCMOS33 } [get_ports { usr_btn[4] }];
set_property -dict { PACKAGE_PIN R18  IOSTANDARD LVCMOS33 } [get_ports { usr_btn[2] }];
set_property -dict { PACKAGE_PIN T18  IOSTANDARD LVCMOS33 } [get_ports { usr_btn[1] }];
